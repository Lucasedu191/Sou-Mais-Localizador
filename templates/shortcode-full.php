<?php
/**
 * Template: Shortcode Full Layout
 *
...
<div class="sm-locator sm-locator--full" data-layout="full">
	<header class="sm-locator__header">
		<h2 class="sm-locator__title"><?php echo esc_html__( 'Encontre a unidade Sou Mais mais próxima', 'soumais-localizador' ); ?></h2>
		<p class="sm-locator__subtitle"><?php echo esc_html__( 'Busque por cidade ou permita que encontremos para você.', 'soumais-localizador' ); ?></p>
	</header>
    ...
    <form class="sm-locator__search" novalidate>
		...
		<div class="sm-locator__search-actions">
			<button type="submit" class="sm-button sm-button--primary"><?php esc_html_e( 'Buscar unidades', 'soumais-localizador' ); ?></button>
	...
	<div class="sm-modal" hidden>
		<div class="sm-modal__dialog" role="dialog" aria-modal="true" aria-labelledby="sm-lead-title">
			...
			<h3 class="sm-modal__title" id="sm-lead-title"><?php esc_html_e( 'Complete seus dados', 'soumais-localizador' ); ?></h3>
			<p class="sm-modal__description">
				<?php esc_html_e( 'Selecione a unidade desejada e receba os planos disponíveis no checkout.', 'soumais-localizador' ); ?>
			</p>
			...
			<form class="sm-locator__lead-form">
				...
				<div class="sm-field sm-field--hidden">
